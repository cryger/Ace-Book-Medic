...
<label class="checkbox-inline">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="cp" class="form-control"  id="address1" placeholder="Codigo Postal">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="pob" class="form-control"  id="address1" placeholder="Poblacion">
    </div>
  </div>
